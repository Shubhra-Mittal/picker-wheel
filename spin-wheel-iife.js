...
var spinWheel = (() => {
  ...
  var L = Math.pow,
    I = (i, e, t) =>
      e in i
        ? R(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
        : (i[e] = t),
    v = (i, e) => {
      for (var t in e || (e = {})) E.call(e, t) && I(i, t, e[t]);
      if (x) for (var t of x(e)) Y.call(e, t) && I(i, t, e[t]);
      return i;
    };
  var q = (i, e) => {
      for (var t in e) R(i, t, { get: e[t], enumerable: !0 });
    },
    $ = (i, e, t, s) => {
  ...
  var Q = (i) => $(R({}, "__esModule", { value: !0 }), i);
  var ee = {};
  q(ee, { Wheel: () => w });
  ...
  function T(i = { x: 0, y: 0 }, e, t, s) {
    return L(i.x - e, 2) + L(i.y - t, 2) <= L(s, 2);
  }
  function S(i = { x: 0, y: 0 }, e = {}, t = 1) {
  ...
  function V(i = 0, e = 0, t = 1) {
    let s = ((i % 360) + e) % 360;
    return (
      (s = J(s)), (s = (t === 1 ? 360 - s : 360 + s) % 360), (s *= t), i + s
    );
  }
  function b(i) {
  ...
  var p = Object.freeze({ left: "left", right: "right", center: "center" }),
    o = Object.freeze({
      wheel: {
        borderColor: "#000",
        borderWidth: 1,
  ...
  var w = class {
    ...
    resize() {
      ...
      let s = Math.min(e, t),
        n = { w: s - s * this._offset.x, h: s - s * this._offset.y },
      ...
      for (let a of this._items)
        this._itemLabelFontSize = Math.min(
          this._itemLabelFontSize,
          P(a.label, this.itemLabelFont, this._labelMaxWidth, this._context)
        );
      this.refresh();
    }
    draw(e = 0) {
        ...
        (e.fillStyle =
          (s = a.backgroundColor) != null
            ...
            : this._itemBackgroundColors[
                n % this._itemBackgroundColors.length
              ]),
          e.fill(a.path);
      }
    }
    drawItemImages(e, t = []) {
      for (let [s, n] of t.entries()) {
        ...
        e.translate(
          this._center.x +
            Math.cos(m(a + -90)) * (this._actualRadius * r.imageRadius),
          this._center.y +
            Math.sin(m(a + -90)) * (this._actualRadius * r.imageRadius)
        ),
    ...
    drawDebugPointerLine(e) {
      !this.debug ||
        ...
        (e.strokeStyle = c.pointerLineColor),
    ...
    drawBorder(e) {
      ...
      if (
        ...
        e.beginPath(),
          (e.strokeStyle = e.strokeStyle = c.labelRadiusColor),
          (e.lineWidth = n),
          e.arc(
            this._center.x,
            this._center.y,
      ...
      for (let [a, d] of t.entries()) {
        ...
        if (
          (e.translate(
            this._center.x +
              Math.cos(m(_ + -90)) *
                (this._actualRadius * this.itemLabelRadius),
            this._center.y +
              Math.sin(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius)
          ),
          e.rotate(m(_ + -90)),
          ...
          this.itemLabelAlign === "left"
            ...
            (e.strokeStyle = c.labelBoundingBoxColor),
            (e.lineWidth = n),
            e.stroke(),
            e.strokeRect(
              f,
        ...
        if (
          ...
          let f = this.getScaledNumber(2);
          e.beginPath(),
            e.arc(0, 0, f, 0, 2 * Math.PI),
            (e.fillStyle = c.labelRadiusColor),
            e.fill();
        }
        e.restore();
      }
    ...
    drawDebugDragPoints(e) {
      ...
      for (let [a, d] of t.entries()) {
        ...
        e.beginPath(),
          ...
          (e.fillStyle = `hsl(${c.dragPointHue},100%,${h}%)`),
          (e.strokeStyle = "#000"),
          (e.lineWidth = s),
          e.fill(),
          e.stroke();
    ...
    animateRotation(e = 0) {
      if (this._spinToTimeEnd !== null) {
        ...
        (this.rotation =
          this._spinToStartRotation + n * this._spinToEasingFunction(s)),
          this.refresh();
        return;
      }
    ...
    getItemAngles(e = 0) {
      ...
      for (let d of this._items)
        (n = d.weight * s), a.push({ start: r, end: r + n }), (r += n);
      return (
    ...
    set items(e) {
      (this._items = l({
        ...
        action: () => {
          let t = [];
          for (let s of e) t.push(new y(this, s));
          return t;
        },
      })),
    ...
    raiseEvent_onCurrentIndexChange(e = {}) {
      ...
      (t = this.onCurrentIndexChange) == null ||
        t.call(
          this,
          v({ type: "currentIndexChange", currentIndex: this._currentIndex }, e)
        );
    }
    raiseEvent_onRest(e = {}) {
      var t;
    ...
    raiseEvent_onSpin(e = {}) {
      var t;
      (t = this.onSpin) == null || t.call(this, v({ type: "spin" }, e));
    }
  };
  return Q(ee);
})();
